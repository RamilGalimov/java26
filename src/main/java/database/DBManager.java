...
public class DBManager implements IDBManager {
    ...
    public void createStudent(String surname, String name, String group, String date) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("INSERT INTO `students_26`.`student` (`surname`, `name`, `group`, `date`) VALUES ('" + surname + "', '" + name + "', '" + group + "', '" + date + "');");
    ...
    public void deleteStudent(String id) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("UPDATE `students_26`.`student` SET `status` = '0' WHERE (`id` = '" + id + "');");
    ...
    public void createNewTerm(String newName, String duration, String[] ids) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("INSERT INTO `students_26`.`term` (`name`, `duration`) VALUES ('" + newName + "', '" + duration + "');");
            ...
            for (String idDisc : ids) {
                stmt.execute("INSERT INTO `students_26`.`term_discipline` (`id_term`, `id_discipline`) VALUES ('" + idTerm + "', '" + idDisc + "');");
    ...
    public void deleteTerm(String idTerm) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("UPDATE `students_26`.`term` SET `status` = '0' WHERE (`id` = '" + idTerm + "'); ");
            stmt.execute("UPDATE `students_26`.`term_discipline` SET `status` = '0' WHERE (`id_term` = '" + idTerm + "');");
    ...
    public void modifyTerm(String idTermModify, String duration, String[] idsDisc) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("UPDATE `students_26`.`term` SET `duration` = '" + duration + "' WHERE (`id` = '" + idTermModify + "');");
            stmt.execute("UPDATE `students_26`.`term_discipline` SET `status` = '0' WHERE (`id_term` = '" + idTermModify + "');");


            for (String idDisc : idsDisc) {
                stmt.execute("INSERT INTO `students_26`.`term_discipline` (`id_term`, `id_discipline`) VALUES ('" + idTermModify + "', '" + idDisc + "');");
