...
<span style="margin-left:152px; font-family: cursive;"><big>Для модифицирования студента отредактируйте все поля и нажмите кнопку "Применить"</big> </span>
<br>
<br>
<br>
<br>
<div class="five">
    <form action="/student-modify" method="post">
        ...
        <input
                style="font-family: cursive; border-color: dimgray; width: 140px;background-color: darkgray; margin-left: 120px; margin-top: 10px;"
